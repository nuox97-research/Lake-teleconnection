...
% CMP.setLabelStr({'welcome','to','follow','my','wechat','official','account','slandarer'})
    ...
    methods
        function obj=corrMatPlot_hold(varargin)
...
% =========================================================================
        function obj=draw(obj)
            ...
            colormap(colorFunc(linspace(0,1,100)));
            caxis([0,1])
            cb=colorbar();
            % 绘制colorbar
            cb.Limits=[0,1];
                    ...
                    switch obj.Type
                        ...
                        case 'ssq'   % 含文本方形
                            ...
                            obj.matrixHdl(row,col).t=text(col,1+obj.num-row,...
                                sprintf('%.2f',obj.corrMat(row,col)),'FontName','Arial','Fontweight','normal','FontSize',20,...
            ...
            tfig=obj.ax.Parent;
            tfig.Position(2)=tfig.Position(2)./3;
            ...
            for col=1:obj.num
                obj.CLabelHdl(col)=text(col,obj.num-5.6-(col-1).*strcmp(obj.Format,'tril'),...
                    obj.Labels{col},'HorizontalAlignment','right',...
                    'FontName','Arial','Fontweight','normal','FontSize',18,'Rotation',45);
            end
            obj.drawn=true;
            ...
            function colorFunc=colorFuncFactory(colorList)
                x=linspace(0,1,size(colorList,1));
